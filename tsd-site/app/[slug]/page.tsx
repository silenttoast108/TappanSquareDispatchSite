...
export default async function storiesPage({
  ...
  params: Promise<{ slug: string }>;
    ...
    if (!(collectionPosts.length == 0)) {//logic for clicking on a collection
      ...
      // console.log(story[0].contributors);
      // console.log(story[0].description);
      // console.log(story[0].spotifyURL);
      // console.log(story[0].images);
      // console.log(story[0].audioURL);
      return (
        <TranscriptPage title={story[0].title} date={story[0]._updatedAt} script={story[0].script} contributors={story[0].contributors} description={story[0].description} spotifyURL={story[0].spotifyURL} images={story[0].images} audioURL={story[0].audioURL}/>
      )
    }
}